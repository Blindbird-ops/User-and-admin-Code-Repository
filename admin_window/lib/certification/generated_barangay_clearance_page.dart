...
class GeneratedBarangayClearancePage extends StatefulWidget {
  final String initialFullName;

  const GeneratedBarangayClearancePage({super.key, required this.initialFullName});

  @override
  _GeneratedBarangayClearancePageState createState() =>
      _GeneratedBarangayClearancePageState();
}

class _GeneratedBarangayClearancePageState extends State<GeneratedBarangayClearancePage> {
  ...
  /// UI Helper: Returns inline spans for the day number and its ordinal suffix.
  ...
  /// PDF Helper: Returns just the ordinal suffix for a given day.
  ...
  Future<void> _printDocument() async {
    ...
    // Load the custom Times New Roman font.
                    ...
                    child: pw.Column(
                      children: [
                        ...
                        pw.Text("Municipality of Taytay",
                            style: pw.TextStyle(font: customFont, fontSize: 12),
                            textAlign: pw.TextAlign.center),
                        pw.Text("Barangay Pularaquen (Canique)",
                            style: pw.TextStyle(font: customFont, fontSize: 12),
                            textAlign: pw.TextAlign.center),
                      ],
                    ),
              ...
              pw.RichText(
                ...
                text: pw.TextSpan(
                  ...
                  children: [
                    ...
                    pw.TextSpan(
                      text:
                          ", legal age, Filipino citizen, and bona fide resident of this Barangay is personally known to me as a law-abiding citizen and has a good moral character.\n\n",
                    ),
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Punong Barangay",
                        ...
                        textAlign: pw.TextAlign.right),
                    pw.SizedBox(height: 30),
                    pw.Text("BOBBY C. ALVEZ",
                        style: pw.TextStyle(font: customFont, fontSize: 12, fontWeight: pw.FontWeight.bold),
                        textAlign: pw.TextAlign.right),
                    pw.Text("Barangay Kagawad",
                        style: pw.TextStyle(font: customFont, fontSize: 12),
                        textAlign: pw.TextAlign.right),
                  ],
                ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Barangay Clearance", style: baseStyle),
        actions: [
          IconButton(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                // Issued Date using RichText with superscript for the day suffix.
                SizedBox(
